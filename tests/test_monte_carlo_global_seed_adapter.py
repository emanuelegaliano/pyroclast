"""GPU integration tests for PyOpenCLMonteCarloGlobalSeedAdapter.

Verifies statistical correctness, reproducibility, single-habitat equivalence,
and lack of cross-talk in the global-seeding MC kernel.
"""

import numpy as np
import pytest

from pyroclast.adapters.opencl_mc_global_seed_adapter import PyOpenCLMonteCarloGlobalSeedAdapter
...
def adapter():
    try:
        return PyOpenCLMonteCarloGlobalSeedAdapter()
